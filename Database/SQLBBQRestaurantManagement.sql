...
-------------------------------------------------------------------------------------------------------------------------------------------------------
INSERT INTO Product_Type (IDType, ProductType)
VALUES ('PROTYPE001', 'Barbecue'),
	   ('PROTYPE002', 'Hotpot'),
	   ('PROTYPE003', 'Snack'),
...
VALUES ('PRO001', 'Combo BBQ 1', 200000, 'Beef brisket, green catfish, octopus',  1, 'PROTYPE001'),
...
-------------------------------------------------------------------------------------------------------------------------------------------------------
INSERT INTO OrderDetails (OrderDetailsID, ProductID, Quantity)
VALUES ('ORD_DETAIL001', 'PRO007', '4'),
	   ('ORD_DETAIL002', 'PRO016', '2'),
	   ('ORD_DETAIL003', 'PRO015', '9'),
	   ('ORD_DETAIL004', 'PRO012', '9'),
	   ('ORD_DETAIL005', 'PRO003', '5'),
	   ('ORD_DETAIL006', 'PRO010', '2'),
	   ('ORD_DETAIL007', 'PRO011', '5'),
	   ('ORD_DETAIL008', 'PRO019', '3'),
	   ('ORD_DETAIL009', 'PRO001', '8'),
	   ('ORD_DETAIL010', 'PRO004', '2'),
	   ('ORD_DETAIL011', 'PRO008', '6'),
	   ('ORD_DETAIL012', 'PRO007', '7'),
	   ('ORD_DETAIL013', 'PRO003', '5'),
	   ('ORD_DETAIL014', 'PRO021', '6'),
	   ('ORD_DETAIL015', 'PRO013', '4'),
	   ('ORD_DETAIL016', 'PRO017', '5'),
	   ('ORD_DETAIL017', 'PRO018', '1'),
	   ('ORD_DETAIL018', 'PRO012', '1'),
	   ('ORD_DETAIL019', 'PRO005', '8'),
	   ('ORD_DETAIL020', 'PRO002', '10'),
	   ('ORD_DETAIL021', 'PRO020', '8'),
	   ('ORD_DETAIL022', 'PRO014', '4'),
	   ('ORD_DETAIL023', 'PRO010', '9'),
	   ('ORD_DETAIL024', 'PRO018', '3'),
	   ('ORD_DETAIL025', 'PRO003', '1'),
	   ('ORD_DETAIL026', 'PRO004', '4');
-------------------------------------------------------------------------------------------------------------------------------------------------------
INSERT INTO Orders (OrderID, DatetimeOrder, Total_Unit_Price, StateOrder, CustomerOrder, DetailsID, OrderStaff)
VALUES ('ORD001', 20230212, 400000, 1, 'CUS001', 'ORD_DETAIL026', 'STA001'),
	   ('ORD002', 20230312, 270000, 1, 'CUS002', 'ORD_DETAIL023', 'STA005'),
	   ('ORD003', 20220711, 40000, 1, 'CUS003', 'ORD_DETAIL022', 'STA005'),
	   ('ORD004', 20210416, 156000, 1, 'CUS004', 'ORD_DETAIL024', 'STA004'),
	   ('ORD005', 20230101, 240000, 1, 'CUS005', 'ORD_DETAIL021', 'STA007'),
	   ('ORD006', 20191205, 1500000, 1, 'CUS006', 'ORD_DETAIL020', 'STA006'),
	   ('ORD007', 20220831, 200000, 1, 'CUS007', 'ORD_DETAIL025', 'STA002'),
	   ('ORD008', 20230131, 800000, 1, 'CUS008', 'ORD_DETAIL001', 'STA001'),
	   ('ORD009', 20210623, 90000, 1, 'CUS009', 'ORD_DETAIL008', 'STA009'),
	   ('ORD010', 20220322, 1600000, 1, 'CUS010', 'ORD_DETAIL009', 'STA006'),
	   ('ORD011', 20220214, 100000, 1, 'CUS011', 'ORD_DETAIL007', 'STA003'),
	   ('ORD012', 20220901, 90000, 1, 'CUS012', 'ORD_DETAIL004', 'STA004'),
	   ('ORD013', 20210112, 60000, 1, 'CUS013', 'ORD_DETAIL006', 'STA008'),
	   ('ORD014', 20220627, 108000, 1, 'CUS014', 'ORD_DETAIL003', 'STA003'),
	   ('ORD015', 20220327, 1000000, 1, 'CUS015', 'ORD_DETAIL005', 'STA006'),
	   ('ORD016', 20230320, 24000, 1, 'CUS016', 'ORD_DETAIL002', 'STA007'),
	   ('ORD017', 20230502, 1500000, 1, 'CUS017', 'ORD_DETAIL011', 'STA007'),
	   ('ORD018', 20230226, 52000, 1, 'CUS018', 'ORD_DETAIL017', 'STA002'),
	   ('ORD019', 20230212, 10000, 1, 'CUS019', 'ORD_DETAIL018', 'STA009'),
	   ('ORD020', 20210517, 250000, 1, 'CUS020', 'ORD_DETAIL016', 'STA008'),
	   ('ORD021', 20210930, 2100000, 1, 'CUS021', 'ORD_DETAIL012', 'STA002'),
	   ('ORD022', 20220412, 40000, 1, 'CUS022', 'ORD_DETAIL015', 'STA008'),
	   ('ORD023', 20221106, 2400000, 1, 'CUS023', 'ORD_DETAIL019', 'STA003'),
	   ('ORD024', 20211212, 150000, 1, 'CUS024', 'ORD_DETAIL014', 'STA004'),
	   ('ORD025', 20220304, 200000, 1, 'CUS025', 'ORD_DETAIL010', 'STA005'),
	   ('ORD026', 20230105, 1000000, 1, 'CUS026', 'ORD_DETAIL013', 'STA001'),
-----VIEW-------------------------------
