...
VALUES ('ORD_DETAIL001', 'PRO007', '4', 'ORD008'),
	   ('ORD_DETAIL002', 'PRO016', '2', 'ORD016'),
	   ('ORD_DETAIL003', 'PRO015', '9', 'ORD014'),
	   ('ORD_DETAIL004', 'PRO012', '9', 'ORD012'),
	   ('ORD_DETAIL005', 'PRO003', '5', 'ORD015'),
	   ('ORD_DETAIL006', 'PRO010', '2', 'ORD013'),
	   ('ORD_DETAIL007', 'PRO011', '5', 'ORD011'),
	   ('ORD_DETAIL008', 'PRO019', '3', 'ORD009'),
	   ('ORD_DETAIL009', 'PRO001', '8', 'ORD010'),
	   ('ORD_DETAIL010', 'PRO004', '2', 'ORD025'),
	   ('ORD_DETAIL011', 'PRO008', '6', 'ORD017'),
	   ('ORD_DETAIL012', 'PRO007', '7', 'ORD021'),
	   ('ORD_DETAIL013', 'PRO003', '5', 'ORD026'),
	   ('ORD_DETAIL014', 'PRO021', '6', 'ORD024'),
	   ('ORD_DETAIL015', 'PRO013', '4', 'ORD022'),
	   ('ORD_DETAIL016', 'PRO017', '5', 'ORD020'),
	   ('ORD_DETAIL017', 'PRO018', '1', 'ORD018'),
	   ('ORD_DETAIL018', 'PRO012', '1', 'ORD019'),
	   ('ORD_DETAIL019', 'PRO005', '8', 'ORD023'),
	   ('ORD_DETAIL020', 'PRO002', '10', 'ORD006'),
	   ('ORD_DETAIL021', 'PRO020', '8', 'ORD005'),
	   ('ORD_DETAIL022', 'PRO014', '4', 'ORD003'),
	   ('ORD_DETAIL023', 'PRO010', '9', 'ORD002'),
	   ('ORD_DETAIL024', 'PRO018', '3', 'ORD004'),
	   ('ORD_DETAIL025', 'PRO003', '1', 'ORD007'),
	   ('ORD_DETAIL026', 'PRO004', '4', 'ORD001');
-------------------------------------------------------------------------------------------------------------------------------------------------------
INSERT INTO Orders (OrderID, DatetimeOrder, Total_Unit_Price, StateOrder, CustomerOrder, OrderStaff)
VALUES ('ORD001', 20230212, 400000, 1, 'CUS001', 'STA001'),
	   ('ORD002', 20230312, 270000, 1, 'CUS002', 'STA005'),
	   ('ORD003', 20220711, 40000, 1, 'CUS003', 'STA005'),
	   ('ORD004', 20210416, 156000, 1, 'CUS004', 'STA004'),
	   ('ORD005', 20230101, 240000, 1, 'CUS005', 'STA007'),
	   ('ORD006', 20191205, 1500000, 1, 'CUS006', 'STA006'),
	   ('ORD007', 20220831, 200000, 1, 'CUS007', 'STA002'),
	   ('ORD008', 20230131, 800000, 1, 'CUS008', 'STA001'),
	   ('ORD009', 20210623, 90000, 1, 'CUS009', 'STA009'),
	   ('ORD010', 20220322, 1600000, 1, 'CUS010', 'STA006'),
	   ('ORD011', 20220214, 100000, 1, 'CUS011', 'STA003'),
	   ('ORD012', 20220901, 90000, 1, 'CUS012', 'STA004'),
	   ('ORD013', 20210112, 60000, 1, 'CUS013', 'STA008'),
	   ('ORD014', 20220627, 108000, 1, 'CUS014', 'STA003'),
	   ('ORD015', 20220327, 1000000, 1, 'CUS015', 'STA006'),
	   ('ORD016', 20230320, 24000, 1, 'CUS016', 'STA007'),
	   ('ORD017', 20230502, 1500000, 1, 'CUS017', 'STA007'),
	   ('ORD018', 20230226, 52000, 1, 'CUS018', 'STA002'),
	   ('ORD019', 20230212, 10000, 1, 'CUS019', 'STA009'),
	   ('ORD020', 20210517, 250000, 1, 'CUS020', 'STA008'),
	   ('ORD021', 20210930, 2100000, 1, 'CUS021', 'STA002'),
	   ('ORD022', 20220412, 40000, 1, 'CUS022', 'STA008'),
	   ('ORD023', 20221106, 2400000, 1, 'CUS023', 'STA003'),
	   ('ORD024', 20211212, 150000, 1, 'CUS024', 'STA004'),
	   ('ORD025', 20220304, 200000, 1, 'CUS025', 'STA005'),
	   ('ORD026', 20230105, 1000000, 1, 'CUS026', 'STA001');
-----VIEW-------------------------------
